                     ...
                     <form:hidden path="organization.id"/>
                        <div class="form-body">
                           <div class="form-group">
                              ...
                              <div class="col-md-10">
                                 <form:input path="username" class="form-control" placeholder="用户名"/><br/>
                           ...
                           <label  class="col-md-2 control-label">密码</label>
                              <div class="col-md-10">
                                 <form:input path="password" class="form-control placeholder-no-fix"  placeholder="请输入密码"/><br/>
                                 <%-- <form:password path="password"   class="form-control placeholder-no-fix"  placeholder="请输入密码" /><br/> --%>
...
<%--                                  <form:password path="password" class="form-control placeholder-no-fix" autocomplete="off" placeholder="密码"/><br/>
                           ...
                           <%-- <label  class="col-md-2 control-label">确认密码</label>
                              <div class="col-md-10">
                                 <form:input path="confirmPassword" class="form-control placeholder-no-fix"  placeholder="请再次输入密码"/><br/>
