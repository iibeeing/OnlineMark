...
<body class="page-header-fixed">
   ...
   <script type="text/javascript">
         ...
         $(".table-toolbar").toolbarLite({
             items: [
				 { link: true, display: "新建", css: "icon-plus", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/add", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>" },
				 { splitter: true }, 
				 { link: true, display: "编辑", css: "icon-edit", showIcon: true, url: "<%=UrlHelper.resolveWithReturnUrl("/account/edit/{0}", request.getAttribute("requestUrl"), request.getAttribute("requestQuery"), pageContext)%>", 
         ...
         $(".glyphicon-pencil").click(function(){
        	 ...
        	 //alert("修改" + id);
        	 var url = "${ctx}/account/toEdit/" + id;
        	 //var url = "${ctx}/account/toRequestEdit?id=" + id;
        	 //alert(url);
         ...
         $(".glyphicon-trash").click(function(){
        	 var name = $(this).parent().parent().attr("id");
        	 //alert("删除" + name);
        	 var url = "${ctx}/account/zlj.controller.ViolationDisciplineController/delete.cqzk";
             $.ajax({
                 async: false,
                 cache: false,
                 type: 'POST',
