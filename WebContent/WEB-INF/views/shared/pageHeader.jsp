       ...
       <!--  <li class="devider">&nbsp;</li> -->
        ...
        <li class="dropdown user">
           ...
           <ul class="dropdown-menu">
              ...
              <li><a href="${pageContext.request.contextPath}/account/login"><i class="icon-off"></i>注销登录</a>
              </li>
              <li class="divider"></li>
              <li><a href="${pageContext.request.contextPath}/account/login"><i class="icon-search"></i>阅卷</a>
              </li>
           </ul>
        </li>
