					...
					<div class="portlet box light-grey">
						...
						<div class="portlet-body form">
							<form name="userForm" action="upload" method="post" enctype="multipart/form-data">
								...
								<div id="fileinfo"></div>
								<div style="text-align: left: ;"><input type="submit" value="上传" class="btn btn-primary"></div>
								
									<div class="pageContent">
										<h2 class="contentTitle">批量导入无效考生数据</h2>
									    ...
									    <div>  
											...
											<div>  
									            ...
									            <input type="button" onClick="javascript:document.getElementById('fileToUpload').click();" value="请选择相应Excel文件 【文件名.xls】"  />
									            <br />
									            <br />
												<strong>
													<a style="background-color:orange;" href="/MyApp/school/template.xls"  target="_blank">>><span>点击下载Excel模版</span></a>
													<br/>
													<br/>
													注释：&nbsp;&nbsp;<font color="red">上传文件为：Execl&nbsp;&nbsp;&nbsp;文件名后缀为：XLS。
													<br />
													<br />
												</strong>
											</div>  
											<div>  
									            <div id="fileNamediv" style="line-height:1.5;"></div>
									            ...
									            <br/>
									            <div><strong>请输入原因</strong></div>
									            <br/>
									            <div>
									            <textarea rows="10" cols="80" id="remark" maxlength="512"></textarea>
									            </div>
									            <br/>
									            <br/>
									            <br/>
										...
										<div >
									    	<div id="progressNumber" style="margin-top:5%; width:300px; height:25px; text-align:right; line-height:25px;"></div> 
									    </div>  
