...
/*	
    ...
    public String list(HttpServletRequest request, Model model, MarkSearchModel searchModel){ 			
        ...
        model.addAttribute("contentModel", markService.listPage(searchModel.getName(), searchModel.getEnable(), pageNo, pageSize));
        return "mark/list";
    }
	...
	public String add(HttpServletRequest request, Model model){	
		...
		{
			MarkEditModel editModel=new MarkEditModel();
    ...
    public String add(HttpServletRequest request, Model model, @ModelAttribute("contentModel") MarkEditModel editModel, BindingResult result) throws EntityOperateException, ValidatException {
        if(result.hasErrors()){
